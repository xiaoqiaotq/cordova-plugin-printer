...
import static org.xiaoqiaotq.cordova.printer.DeviceConnFactoryManager.ACTION_QUERY_PRINTER_STATE;
import static org.xiaoqiaotq.cordova.printer.DeviceConnFactoryManager.CONN_STATE_FAILED;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    public void btnConnect(View view) {
        startActivityForResult(new Intent(MainActivity2.this, BluetoothListActivity.class), BLUETOOTH_REQUEST_CODE);
    }
            ...
            if (DeviceConnFactoryManager.ACTION_CONN_STATE.equals(action)) {
                ...
                switch (state) {
                    ...
                    case CONN_STATE_FAILED:
                        ...
                        Toast.makeText(MainActivity2.this, "连接失败！重试或重启打印机试试", Toast.LENGTH_SHORT).show();
                        break;
                }
                /* Usb连接断开、蓝牙连接断开广播 */
            ...
            switch (msg.what) {
                case CONN_STATE_DISCONN:
                    if (DeviceConnFactoryManager.getDeviceConnFactoryManagers()[id] != null || !DeviceConnFactoryManager.getDeviceConnFactoryManagers()[id].getConnState()) {
                        ...
                        Toast.makeText(MainActivity2.this, "成功断开连接", Toast.LENGTH_SHORT).show();
                    }
                    break;
                case PRINTER_COMMAND_ERROR:
                    Toast.makeText(MainActivity2.this, "请选择正确的打印机指令", Toast.LENGTH_SHORT).show();
                    break;
                case CONN_PRINTER:
                    Toast.makeText(MainActivity2.this, "请先连接打印机", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
